...
if st.button("Add task"):
    if not st.session_state.owner or owner_name != st.session_state.owner.name:
        owner = Owner(owner_name)
        st.session_state.owner = owner
    
    if not st.session_state.owner.get_pet(pet_name, species):
        st.session_state.owner.add_pet(Pet(pet_name, species))
    
    pet = st.session_state.owner.get_pet(pet_name, species)
